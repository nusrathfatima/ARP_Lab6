...
#'      \item \code{plot()}: plots the following two plots using \code{ggplot2}.
...
#'
#' @author \itemize{
#'      \item Teno Gonzalez Dos Santos - \url{https://github.com/tenoglez}
#'      \item Josue Alvarez Robles - \url{https://github.com/ejarkm}
#'      \item Jose Luis Lopez Ruiz - \url{https://github.com/pepelu8000}
#'    }
#' 
